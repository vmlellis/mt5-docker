...
//--- +infinity
   ...
   if(prob==0.0)
      return 0.0;
//--- return quantile
   return MathRound(-1.0+MathLog(1.0-prob)/MathLog(1.0-p));
  }
//+------------------------------------------------------------------+
//| Geometric distribution quantile function (inverse CDF)           |
//+------------------------------------------------------------------+
   ...
   for(int i=0; i<data_count; i++)
     {
      ...
      if(prob==0.0)
         ...
         result[i]=MathRound(-1.0+MathLog(1.0-prob)/MathLog(1.0-p));
     }
   return true;
  }
//+------------------------------------------------------------------+
...
//--- return geometric distributed
   return MathRound(-1.0+MathLog(rnd)/MathLog(1.0-p));
  }
//+------------------------------------------------------------------+
//| Random variate from the Geometric distribution                   |
//+------------------------------------------------------------------+
   ...
   for(int i=0; i<data_count; i++)
     {
      //--- generate random number
      double rnd=MathRandomNonZero();
      result[i]=MathRound(-1.0+MathLog(rnd)/MathLog(1.0-p));
     }
   return true;
  }
//+------------------------------------------------------------------+
