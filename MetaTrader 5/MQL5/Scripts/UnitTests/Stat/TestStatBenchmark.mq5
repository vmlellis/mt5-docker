...
//--- probability density
   benchmark.pdf_time_min=MathMin(pdf_times,0,WHOLE_ARRAY);
   benchmark.pdf_time_max=MathMax(pdf_times,0,WHOLE_ARRAY);
   benchmark.pdf_time_mean=MathMean(pdf_times,0,WHOLE_ARRAY);
   benchmark.pdf_time_median=MathMedian(pdf_times,0,WHOLE_ARRAY);
   benchmark.pdf_time_stddev=MathStandardDeviation(pdf_times,0,WHOLE_ARRAY);
   benchmark.pdf_time_avgdev=MathAverageDeviation(pdf_times,0,WHOLE_ARRAY);
//--- cumulative distribution
   benchmark.cdf_time_min=MathMin(cdf_times,0,WHOLE_ARRAY);
   benchmark.cdf_time_max=MathMax(cdf_times,0,WHOLE_ARRAY);
   benchmark.cdf_time_mean=MathMean(cdf_times,0,WHOLE_ARRAY);
   benchmark.cdf_time_median=MathMedian(cdf_times,0,WHOLE_ARRAY);
   benchmark.cdf_time_stddev=MathStandardDeviation(cdf_times,0,WHOLE_ARRAY);
   benchmark.cdf_time_avgdev=MathAverageDeviation(cdf_times,0,WHOLE_ARRAY);
//--- quantile
   benchmark.quantile_time_min=MathMin(quantile_times,0,WHOLE_ARRAY);
   benchmark.quantile_time_max=MathMax(quantile_times,0,WHOLE_ARRAY);
   benchmark.quantile_time_mean=MathMean(quantile_times,0,WHOLE_ARRAY);
   benchmark.quantile_time_median=MathMedian(quantile_times,0,WHOLE_ARRAY);
   benchmark.quantile_time_stddev=MathStandardDeviation(quantile_times,0,WHOLE_ARRAY);
   benchmark.quantile_time_avgdev=MathAverageDeviation(quantile_times,0,WHOLE_ARRAY);
//--- random values
   benchmark.random_time_min=MathMin(random_times,0,WHOLE_ARRAY);
   benchmark.random_time_max=MathMax(random_times,0,WHOLE_ARRAY);
   benchmark.random_time_mean=MathMean(random_times,0,WHOLE_ARRAY);
   benchmark.random_time_median=MathMedian(random_times,0,WHOLE_ARRAY);
   benchmark.random_time_stddev=MathStandardDeviation(random_times,0,WHOLE_ARRAY);
   benchmark.random_time_avgdev=MathAverageDeviation(random_times,0,WHOLE_ARRAY);
   return;
  }
//+------------------------------------------------------------------+
