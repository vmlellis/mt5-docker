...
//| Constructor with parameters                                      |
//+------------------------------------------------------------------+
CP_ShapedMembershipFunction::CP_ShapedMembershipFunction(const double a,const double d,const double b,const double c)
  {
   m_a=a;
   m_d=d;
   m_b=b;
...
double CP_ShapedMembershipFunction::GetValue(const double x)
  {
   CZ_ShapedMembershipFunction z_function(m_a,m_d);
   CS_ShapedMembershipFunction s_function(m_b,m_c);
